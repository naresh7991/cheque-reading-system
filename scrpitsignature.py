...
#     img = ndimage.binary_erosion(img).astype(img.dtype)
    ...
    def EccentricitySolidity(img):
        r = regionprops(img.astype("int8"),coordinates='xy')
...
#makeCSV()
    ...
    n_input = 9
    train_person_id = iddd
    test_image_path = 'cropped.png'
...
# Initializing the variables
    ...
    def evaluate(train_path, test_path, type2=False):   
        ...
        # Training cycle
            ...
            print(accuracy1)
        #rint("Accuracy for train:", accuracy1)
#         print("Accuracy for test:", accuracy2)
    ...
    def trainAndTest(rate=0.001, epochs=1700, neurons=7, display=True):    
        start = time()
